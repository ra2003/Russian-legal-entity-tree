## Доработка и поддержка в дальнейшем лишена смысла, т.к. на сайте http://www.rusprofile.ru/ появилась функция отображения связей юридических лиц "из коробки". Помянем.
